...
public:     //méthodes de la classe Arduino
    ...
    QString read_card_content_as_string();

    //bool check_card_password(const QString &cardData);  // NEW: compare RFID data with database
    bool check_card_password(const QByteArray &cardData);
