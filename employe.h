...
public:
    employe();
    employe(int matricule, const QString& nom_em, const QString& prenom_em,  const QDate& dateN, const QString& email, const QString& Role, const QString& Mot_de_passe, int etat);
