...
public:
    ...
    QPushButton *pushButton_readCardData;
...
"}\n"
""));
        label_picc = new QLabel(centralwidget);
        label_picc->setObjectName("label_picc");
        label_picc->setGeometry(QRect(-8, 0, 931, 541));
...
"\n"
""));
        pushButton_readCardData = new QPushButton(frame);
        pushButton_readCardData->setObjectName("pushButton_readCardData");
        pushButton_readCardData->setGeometry(QRect(350, 240, 83, 29));
        label_login_img = new QLabel(centralwidget);
        label_login_img->setObjectName("label_login_img");
        label_login_img->setGeometry(QRect(390, 30, 121, 111));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_readCardData->setText(QCoreApplication::translate("MainWindow", "PushButton", nullptr));
