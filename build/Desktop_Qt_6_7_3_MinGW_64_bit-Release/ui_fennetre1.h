...
""));
        ...
        sponsor = new QPushButton(frame);
        sponsor->setObjectName("sponsor");
        sponsor->setGeometry(QRect(610, 10, 111, 41));
        sponsor->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"\n"
""));
        billet = new QPushButton(frame);
        billet->setObjectName("billet");
        billet->setGeometry(QRect(490, 10, 111, 41));
        billet->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    border: 2px solid #003153;   /* Prussian Blue border */\n"
"    border-radius: 10px;         /* Round the corners */\n"
"    padding: 0 8px;              /* Padding inside the button */\n"
"    background: #003153;         /* Prussian Blue background */\n"
...
"}\n"
""));
        match = new QPushButton(frame);
        match->setObjectName("match");
        match->setGeometry(QRect(250, 10, 111, 41));
        match->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    border: 2px solid #003153;   /* Prussian Blue border */\n"
"    border-radius: 10px;         /* Round the corners */\n"
"    padding: 0 8px;              /* Padding inside the button */\n"
"    background: #003153;         /* Prussian Blue background */\n"
...
"}\n"
""));
        equipe = new QPushButton(frame);
        equipe->setObjectName("equipe");
        equipe->setGeometry(QRect(130, 10, 111, 41));
        equipe->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    border: 2px solid #003153;   /* Prussian Blue border */\n"
"    border-radius: 10px;         /* Round the corners */\n"
"    padding: 0 8px;              /* Padding inside the button */\n"
"    background: #003153;         /* Prussian Blue background */\n"
...
"}"));
    ...
    void retranslateUi(QDialog *fennetre1)
    {
        ...
        sponsor->setText(QCoreApplication::translate("fennetre1", "Sponsor", nullptr));
        billet->setText(QCoreApplication::translate("fennetre1", "Billet", nullptr));
        pushButton_20->setText(QCoreApplication::translate("fennetre1", "Employer", nullptr));
        match->setText(QCoreApplication::translate("fennetre1", "Match", nullptr));
        equipe->setText(QCoreApplication::translate("fennetre1", "Equipe", nullptr));
